...
public class AliOssUtil {
    ...
    public static String upload(File file) {
        ...
        String accessKeyId = "LTAI5tEaKLSzS8hcoaBjtur3";
        String accessKeySecret = "3guKNKckeadhyE5Z6kHfuc4L3c4FSx";
        ...
        //拼接URL
        String url = "https://so-coin.oss-cn-beijing.aliyuncs.com/" + filePath + newFileName;
        ossClient.shutdown();
        return url;
    }
}
